...
(function( $ ) {
  ...
  var pluginName = "xrayhtml",
	...
	// Bind Prism.js to code blocks
	$( window ).bind( "create.xrayhtml", function( e ) {
		var prism = !!~e.target.getAttribute( "class" ).indexOf( "prism" );

			// Marking each instance of prism with their specific markup language
			var prisms = $(".prism");
			prisms.each(function(index) {
				$(".prism.sass").find( "code" ).addClass( "language-scss" );
				$(".prism.html").find( "code" ).addClass( "language-markup" );
				$(".prism.javascript").find( "code" ).addClass( "language-javascript" );
				$(".prism.json").find( "code" ).addClass( "language-json" );
				$(".prism.handlebars").find( "code" ).addClass( "language-handlebars" );
				$(".prism.panini").find( "code" ).addClass( "language-handlebars" );
				Prism.highlightAll();	
			});
